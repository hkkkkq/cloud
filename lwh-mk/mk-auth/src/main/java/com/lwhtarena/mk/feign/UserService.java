package com.lwhtarena.mk.feign;

import com.lwhtarena.mk.common.vo.UserVO;
import com.lwhtarena.mk.feign.fallback.UserServiceFallbackImpl;
 ...
 */
@FeignClient(name = "mk-upms-service", fallback = UserServiceFallbackImpl.class)
