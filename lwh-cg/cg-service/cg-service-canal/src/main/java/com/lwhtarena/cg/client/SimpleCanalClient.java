package com.lwhtarena.cg.client;
...
public class SimpleCanalClient extends AbstractCanalClient {
	...
	private void initListeners() {
		...
		//获取监听器
		List<CanalEventListener> list = BeanCovertUtil.getBeansOfType(CanalEventListener.class);
		...
		//若是你喜欢通过注解的方式去监听的话。。
		Map<String, Object> listenerMap = BeanCovertUtil.getBeansWithAnnotation(CanalEventListener.class);
		//也放入 map
		if (listenerMap != null) {
